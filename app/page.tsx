  ...
  return (
    <div className="min-h-screen app-bg text-white">
      ...
      <div style={{ position: "absolute", zIndex: 99999 }}>
        <input autoComplete="off" type="checkbox" id="aadsstickymnkjj2am" hidden />
        <div style={{ paddingTop: 0, paddingBottom: "auto" }}>
          <div style={{ width: "100%", height: "auto", position: "fixed", textAlign: "center", fontSize: 0, bottom: 0, left: 0, right: 0, margin: "auto", zIndex: 99998 }}>
            <label htmlFor="aadsstickymnkjj2am" style={{ top: "50%", transform: "translateY(-50%)", right: "24px", position: "absolute", borderRadius: "4px", background: "rgba(248, 248, 249, 0.70)", padding: "4px", zIndex: 99999, cursor: "pointer" }}>
            ...
            <div id="frame" style={{ width: "100%", margin: "auto", position: "relative", zIndex: 99998 }}>
              <iframe 
                ...
                style={{ 
                  ...
                  padding: 0, 
                  width: "70%", 
                  height: "100px", /* Adjusted height as auto might not work well for iframe */
                  overflow: "hidden", 
                  margin: "auto" 
                }}
              ></iframe>
          ...
          <style dangerouslySetInnerHTML={{ __html: `
            #aadsstickymnkjj2am:checked + div {
              display: none;
            }
          ` }} />
        </div>
